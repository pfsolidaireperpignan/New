...
window.baseClientsNextPage = DB.baseClientsNextPage;
window.baseClientsPrevPage = DB.baseClientsPrevPage;
window.adminDossiersNextPage = DB.adminDossiersNextPage;
window.adminDossiersPrevPage = DB.adminDossiersPrevPage;
...
window.showAdminListView = function() {
...
window.showAdminDetailView = function() {
